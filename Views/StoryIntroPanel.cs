    ...
    public class StoryIntroPanel : Panel
    {
        ...
        private void ConfigureInnerTable(TableLayoutPanel innerTable)
        {
            var textLabel = new Label()
            {
                ...
                Font = new Font(SystemFonts.DialogFont.FontFamily, 14),
                BackgroundImage = Resources.quartzBackground,
            };
            ...
            innerTable.RowStyles.Add(new RowStyle(SizeType.Percent, 92));
            innerTable.RowStyles.Add(new RowStyle(SizeType.Percent, 8));

            innerTable.Controls.Add(textLabel, 0, 0);
